...
// کامپوننت اصلی MedicalHistorySection
const MedicalHistorySection = React.memo(({
  medicalHistory = [],
  onAdd,
  onEdit,
  onRemove,
  ...
  const safeItems = Array.isArray(medicalHistory) ? medicalHistory : [];
      ...
      <div className="flex items-center justify-between mb-4 md:mb-6">
        <div className="flex items-center gap-2 md:gap-3">
          <div className="p-2 md:p-3 rounded-lg bg-red-100">
            <FiClipboard className="w-5 h-5 md:w-6 md:h-6 text-red-600" />
          </div>
          <div>
        ...
        <div className="mt-4 md:mt-6 pt-4 md:pt-6 border-t border-gray-200">
          <div className="flex flex-col md:flex-row gap-2 md:gap-3">
            <input
              ...
              className="flex-1 px-3 md:px-4 py-2 md:py-3 border-2 border-red-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all text-right text-sm md:text-base placeholder:text-gray-400"
              autoComplete="off"
              spellCheck="false"
              maxLength={200}
            />
            <div className="flex gap-2 md:gap-3">
              <button
                ...
                className="flex-1 md:flex-none flex items-center justify-center gap-1 md:gap-2 px-3 py-2 md:px-5 md:py-3 bg-red-600 hover:bg-red-700 text-white rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg"
