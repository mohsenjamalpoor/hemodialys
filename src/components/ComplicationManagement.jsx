  ...
  return (
    <header className="bg-gradient-to-r from-blue-600 to-purple-700 text-white shadow-lg">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mt-6 bg-white/10 backdrop-blur-sm rounded-xl p-4 max-w-4xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center text-sm">
            <div className="space-y-1">
              <div className="text-xl">🫀</div>
              <h3 className="font-semibold">عوارض قلبی</h3>
              <p className="text-xs opacity-80">شایع‌ترین عوارض</p>
            </div>
            <div className="space-y-1">
              <div className="text-xl">💪</div>
              <h3 className="font-semibold">عضلانی</h3>
              <p className="text-xs opacity-80">کرامپ و اسپاسم</p>
            </div>
            <div className="space-y-1">
              <div className="text-xl">🧠</div>
              <h3 className="font-semibold">عصبی</h3>
              <p className="text-xs opacity-80">DDS و تشنج</p>
            </div>
            <div className="space-y-1">
              <div className="text-xl">🩸</div>
              <h3 className="font-semibold">هماتولوژیک</h3>
              <p className="text-xs opacity-80">خونریزی و انعقاد</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="bg-white rounded-xl shadow-lg p-4 mb-6 border border-gray-200">
      ...
      <div className="mt-4 pt-3 border-t border-gray-200">
        <div className="flex flex-wrap gap-2 justify-center text-xs text-gray-600">
          <span className="bg-blue-50 px-2 py-1 rounded-full">🫀 قلبی: ۲ مورد</span>
          <span className="bg-green-50 px-2 py-1 rounded-full">💪 عضلانی: ۱ مورد</span>
          <span className="bg-yellow-50 px-2 py-1 rounded-full">🧠 عصبی: ۱ مورد</span>
          <span className="bg-red-50 px-2 py-1 rounded-full">🩸 خونی: ۱ مورد</span>
        </div>
      </div>
    </div>
  );
      ...
      <footer className="bg-gray-800 text-white py-6 mt-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-gray-300 text-sm">
            سیستم مدیریت عوارض همودیالیز کودکان - نسخه ۱.۰
          </p>
          <p className="text-gray-400 text-xs mt-1">
            بر اساس آخرین راهنماهای بالینی و مطالعات pediatric nephrology
          </p>
        </div>
      </footer>
