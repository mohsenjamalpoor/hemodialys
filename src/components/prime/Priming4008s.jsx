...
const STEPS = [
  ...
  { key: "saline", titleFa: "اتصال سالین: نرمال سالین را به لاین شریانی وصل کنید", hintEn: "Spike arterial line into NS bag; hang bag.", detailsFa: "ست شریانی را به سرم وصل و آویزان کنید. کلمپ نزدیک اسپایک را باز کنید. محفظه شریانی تا نصف پر شود.", highlights: ["saline", "arterial", "artChamber"] },
  { key: "primeArt", titleFa: "پرایم اولیه: پمپ خون را آرام راه‌اندازی کنید", hintEn: "Start blood pump ~150 mL/min to fill lines.", detailsFa: "پمپ خون را روی حدود 100 mL/min بگذارید. کلمپ‌های مسیر شریانی را باز کنید تا مسیر تا صافی پر شود و حباب‌ها خارج شوند.", highlights: ["pump", "arterial", "dialyzer"] },
  ...
  { key: "primeVen", titleFa: "مسیر وریدی: محفظه وریدی را در محل خود و تا خط علامت پر کنید", hintEn: "Fill venous chamber to line; check for air.", detailsFa: "جریان را ادامه دهید تا محفظه وریدی تا خط مشخص پر شود. پیچ هواگیری را باز و بسته کنید تا حباب‌ها خارج شوند.", highlights: ["venous", "venChamber"] },
...
// -------------------- Circuit SVG --------------------
function CircuitSVG({ running, highlights, style }) {
  ...
  return (
    <svg viewBox="0 0 800 500" className="w-full h-auto" style={style}>
      ...
      <g transform="translate(620,0)">
        <rect x={20} y={20} width={60} height={100} rx={8} fill="#fff" stroke="#cbd5e1" opacity={dim("saline")} />
        <text x={25} y={140} fontSize={12} fill="#0f172a">Saline</text>
        <line x1={50} y1={120} x2={50} y2={180} stroke="#10b981" strokeWidth={4} opacity={dim("saline")} />
      </g>

      {/* Arterial line */}
      <line x1={670} y1={180} x2={300} y2={180} stroke="#ef4444" strokeWidth={6} opacity={dim("arterial")} />
      <line x1={670} y1={180} x2={300} y2={180} stroke="#fb7185" strokeWidth={2} strokeDasharray="6 8"
      ...
      {/* Venous line */}
      <line x1={490} y1={280} x2={200} y2={280} stroke="#2563eb" strokeWidth={6} opacity={dim("venous")} />
      <line x1={490} y1={280} x2={200} y2={280} stroke="#60a5fa" strokeWidth={2} strokeDasharray="6 8"
